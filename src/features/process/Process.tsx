...
export default function Process() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed top-0 right-0 w-[800px] h-[800px] bg-deep-teal/20 rounded-full blur-[150px] transform-gpu pointer-events-none z-0" />
          ...
          <SectionReveal>
            <div className="flex flex-col items-center">
              ...
              <h1 className="font-ibm text-[14vw] xs:text-6xl md:text-7xl lg:text-[90px] xl:text-[130px] font-light text-white leading-[1.1] md:leading-[0.85] tracking-tighter mb-8 md:mb-12">
                Creative <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-yellow to-neon-yellow/40 glow-text-yellow block sm:inline mt-2 sm:mt-0 uppercase">Pipeline.</span>
              </h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-12">
                {step.details.map((detail, i) => (
                  <div key={i} className="group/item flex items-center justify-between p-4 bg-white/[0.02] border border-white/5 rounded-xl hover:border-white/10 transition-all duration-500">
                    <span className="font-ibm tracking-[0.1em] text-[10px] text-white/40 group-hover:text-white transition-colors uppercase">{detail}</span>
