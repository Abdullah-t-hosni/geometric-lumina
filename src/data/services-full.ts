...
export const services: Service[] = [
  ...
  },
  {
    ...
    color: 'sea-green',
    image: {
      src: getAsset('Social Media Content', import.meta.url),
      blur: getBlurAsset('Social Media Content', import.meta.url),
    },
    heroImage: getAsset('Social Media Content', import.meta.url),
    icon: Share2,
    featured: false,
    priority: 4,
    stats: [
  ...
  },
  {
    ...
    color: 'coral-red',
    image: {
      src: getAsset('Simulations', import.meta.url),
      blur: getBlurAsset('Simulations', import.meta.url),
    },
    heroImage: getAsset('6', import.meta.url),
    gallery: [getAsset('Simulations', import.meta.url), getAsset('6', import.meta.url)],
    icon: Wind,
    featured: false,
    priority: 6,
    stats: [
  ...
  },
  {
    ...
    color: 'sky-blue',
    image: {
      src: getAsset('Architectural Visualization', import.meta.url),
      blur: getBlurAsset('Architectural Visualization', import.meta.url),
    },
    heroImage: getAsset('Services', import.meta.url),
    gallery: [getAsset('Architectural Visualization', import.meta.url), getAsset('Services', import.meta.url)],
    icon: Home,
    featured: false,
    priority: 7,
    stats: [
  ...
  },
  {
    ...
    color: 'sea-green',
    image: {
      src: getAsset('Micro-Visualization', import.meta.url),
      blur: getBlurAsset('Micro-Visualization', import.meta.url),
    },
    heroImage: getAsset('Micro-Visualization', import.meta.url),
    gallery: [getAsset('Micro-Visualization', import.meta.url), getAsset('Product Visualization & Animation', import.meta.url), getAsset('Simulations', import.meta.url)],
    icon: Microscope,
    featured: false,
    priority: 8,
    stats: [
  ...
  },
  {
    ...
    color: 'sky-blue',
    image: {
      src: getAsset('CGI Compositing', import.meta.url),
      blur: getBlurAsset('CGI Compositing', import.meta.url),
    },
    heroImage: getAsset('Intro_Page', import.meta.url),
    icon: Component,
    featured: false,
    priority: 10,
    stats: [
  ...
  },
  {
    ...
    color: 'coral-red',
    image: {
      src: getAsset('3D Scanning', import.meta.url),
      blur: getBlurAsset('3D Scanning', import.meta.url),
    },
    heroImage: getAsset('3D Scanning', import.meta.url),
    gallery: [getAsset('3D Scanning', import.meta.url), getAsset('Product Visualization & Animation', import.meta.url), getAsset('Micro-Visualization', import.meta.url)],
    icon: Scan,
    featured: false,
    priority: 11,
    stats: [
