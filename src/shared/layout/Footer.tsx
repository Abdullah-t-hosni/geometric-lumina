...
export default function Footer() {
  ...
  const socialLinks = useMemo(() => [
    ...
    { icon: Twitter, label: 'Twitter', href: 'https://x.com/geometric_stud' },
  ...
  return (
    <footer role="contentinfo" aria-label="Geometric Studio site footer" className="relative bg-background overflow-hidden pb-12 z-10">
      ...
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-deep-teal/10 rounded-full blur-[60px] md:blur-[120px] transform-gpu will-change-transform pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-neon-yellow/[0.03] rounded-full blur-[50px] md:blur-[100px] transform-gpu will-change-transform pointer-events-none" />
      ...
      <div className="max-w-[1440px] mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-16 lg:gap-20 py-20 md:py-32 border-b border-white/5">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16 text-left">
            ...
            <nav aria-label="Footer navigation options" className="contents">
              {/* Nav Node */}
