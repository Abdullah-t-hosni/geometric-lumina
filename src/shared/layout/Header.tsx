...
const navLinks = [
  { label: 'Home', href: '/', prefetch: () => import('@/features/home') },
  ...
  return (
    <>
      ...
      <m.header
        ...
        role="banner"
        className={`fixed top-0 left-0 right-0 z-50 transition-[background,padding,transform,opacity] duration-500 will-change-transform ${
          scrolled && !menuOpen ? 'bg-background/80 backdrop-blur-md border-b border-white/5 py-2 shadow-lg shadow-black/20' : 'bg-transparent py-4'
        }`}
      >
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`relative inline-flex items-center gap-2 tracking-[0.25em] uppercase transition-[color,transform] duration-500 group hover:-translate-y-[2px] ${
